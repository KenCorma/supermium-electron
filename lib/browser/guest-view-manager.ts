...
const watchEmbedder = function (embedder: Electron.WebContents) {
  ...
  embedder.on('-window-visibility-change' as any, onVisibilityChange as any);
  ...
  embedder.once('will-destroy' as any, () => {
    ...
    // Clear the listeners.
    embedder.removeListener('-window-visibility-change' as any, onVisibilityChange as any);
